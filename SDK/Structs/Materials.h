...
public:
	...
	virtual preview_image_retval_t get_preview_image_properties(int* width, int* height, ImageFormat* image_format, bool* is_translucent) const = 0;
	virtual preview_image_retval_t get_preview_image(unsigned char* data, int width, int height, ImageFormat image_format) const = 0;
	...
	virtual Material* get_material_page(void) = 0;
	...
	virtual void set_material_var_flag(MaterialVarFlags flag, bool on) = 0;
	virtual bool get_material_var_flag(MaterialVarFlags flag) const = 0;
