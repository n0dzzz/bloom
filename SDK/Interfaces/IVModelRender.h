...
public:
    ...
    virtual bool                    DrawModelSetup(ModelRenderInfo_t& pInfo, DrawModelState* pState, matrix3x4_t** ppBoneToWorldOut) = 0;
    virtual void                    DrawModelExecute(IMatRenderContext* ctx, const DrawModelState& state, const ModelRenderInfo_t& pInfo, matrix3x4_t* pCustomBoneToWorld = NULL) = 0;
